    ...
    return Column(
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            ...
            image: const DecorationImage(
              fit: BoxFit.cover,
              image: AssetImage(ItemController.image_item8)
            )
        ...
        Container(
          ...
          child: Obx(() => Text(
            '${RFIDRead_GX.Plasticwrap_NameGX_display.value}',
            style: TextStyle(
          ...
          children: [
            Padding(
              ...
              child: Container(
                alignment: Alignment.center,
                child: Obx(() => Text(
                  'Price: RM ${RFIDRead_GX.Plasticwrap_PriceGX_display.value}',
                  style: TextStyle(
            ...
            Padding(
              ...
              child: Container(
                alignment: Alignment.center,
                child: Obx(() => Text(
                  'Qty: ${RFIDRead_GX.Plasticwrap_QuantityGX_display.value}',
                  style: TextStyle(
                    fontSize: componentsize.pricetext_size, 
                    color: Colors.black, 
                    fontWeight: FontWeight.w600
                  ...
                  showDialog(
                    ...
                    builder: (context) => AlertDialog(
                      ...
                      actions: [
                        ...
                        TextButton(
                          onPressed: () {
                            navigationfunction.Sendcoordinate('10');
                            Navigator.pop(context);
                            showDialog(
                              context: context, 
    ...
    children: [
        ...
        children: [
          ...
          Padding(
            ...
            child: Container(
              alignment: Alignment.center,
              child: Text(
                '   Location: ${RFIDRead_GX.Plasticwrap_LocationGX_display.value}',
                style: TextStyle(
                  fontSize: 20, 
                  color: Colors.black, 
                  fontWeight: FontWeight.w600
      ...
      Padding(
        ...
        child: Container(
          alignment: Alignment.center,
          child: Text(
            '${RFIDRead_GX.Plasticwrap_DescriptionGX_display.value}',
            style: TextStyle(
              fontSize: 20, 
              color: Colors.black, 
              fontWeight: FontWeight.w600
    ...
    content: SizedBox(
      ...
      child: Column(
        children: [
          ...
          Text(
            '${RFIDRead_GX.Plasticwrap_NameGX_display.value} ${RFIDRead_GX.Plasticwrap_LocationGX_display.value}',
            textAlign: TextAlign.center,
            style: TextStyle(
              fontSize: 50,
              fontWeight: FontWeight.bold
